...
(defn md-to-html
  ...
  nil is returned."
  [in out & params]
  (binding [clj-ts.markdown.common/*substring* (fn [^String s n] (.substring s n))
            clj-ts.markdown.transformers/*formatter* clojure.core/format]

...
var G__11946 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__11946;
continue;
} else {
return ch;
...
var vec__11947 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__11947,(0),null);
return (match === s);
});
...
var len__4641__auto___11952 = arguments.length;
var i__4642__auto___11953 = (0);
while(true){
if((i__4642__auto___11953 < len__4641__auto___11952)){
args__4647__auto__.push((arguments[i__4642__auto___11953]));

var G__11954 = (i__4642__auto___11953 + (1));
i__4642__auto___11953 = G__11954;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq11950){
var G__11951 = cljs.core.first.call(null,seq11950);
var seq11950__$1 = cljs.core.next.call(null,seq11950);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11951,seq11950__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__11955__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__11955 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__11956__i = 0, G__11956__a = new Array(arguments.length -  1);
while (G__11956__i < G__11956__a.length) {G__11956__a[G__11956__i] = arguments[G__11956__i + 1]; ++G__11956__i;}
  _ = new cljs.core.IndexedSeq(G__11956__a,0,null);
} 
return G__11955__delegate.call(this,rdr,_);};
G__11955.cljs$lang$maxFixedArity = 1;
G__11955.cljs$lang$applyTo = (function (arglist__11957){
var rdr = cljs.core.first(arglist__11957);
var _ = cljs.core.rest(arglist__11957);
return G__11955__delegate(rdr,_);
});

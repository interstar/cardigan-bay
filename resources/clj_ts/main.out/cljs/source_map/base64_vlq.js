...
var digit_13421 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_13422__$1 = (vlq >>> (5));
while(true){
if((vlq_13422__$1 > (0))){
var digit_13423__$1 = (digit_13421 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_13423__$1));

var G__13424 = (vlq_13422__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__13425 = (vlq_13422__$1 >>> (5));
digit_13421 = G__13424;
vlq_13422__$1 = G__13425;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_13421));
}
break;
}
...
var G__13426 = i__$1;
var G__13427 = result__$1;
var G__13428 = shift__$1;
i = G__13426;
result = G__13427;
shift = G__13428;
continue;

...
}catch (e25793){var _e = e25793;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___25796 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___25796)){
var seen_errors_25797 = temp__5733__auto___25796;
if(cljs.core.truth_(seen_errors_25797.has(self))){
} else {
seen_errors_25797.add(self);

var temp__5735__auto___25798 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___25798)){
var sense_25799 = temp__5735__auto___25798;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25799)].join('');
} else {
}
}
} else {

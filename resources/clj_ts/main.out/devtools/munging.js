...
var o23157 = temp__5733__auto__;
var temp__5733__auto____$1 = (o23157["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23158 = temp__5733__auto____$1;
return (o23158["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22249__auto__ = f;
return (o__22249__auto__["toString"]).call(o__22249__auto__);
} else {
return "";
}
...
try{var o__22249__auto___23161 = t;
(o__22249__auto___23161["cljs$lang$ctorPrWriter"]).call(o__22249__auto___23161,t,writer);
}catch (e23160){var __23162 = e23160;
}
...
var char_code = (function (){var o__22249__auto__ = (new String(char$));
return (o__22249__auto__["charCodeAt"]).call(o__22249__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22249__auto__ = String;
return (o__22249__auto__["fromCharCode"]).call(o__22249__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23163 = num_code;
switch (G__23163) {
case (1):
return (185);
...
var o__22249__auto__ = String;
return (o__22249__auto__["fromCharCode"]).call(o__22249__auto__,superscript_code);
});
/**
...
}catch (e23165){var _e__22256__auto__ = e23165;
return false;
}})())){
...
var vec__23166 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23166,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o23169 = temp__5733__auto__;
var temp__5733__auto____$1 = (o23169["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23170 = temp__5733__auto____$1;
return (o23170["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23173){
var vec__23174 = p__23173;
var ns_detector = cljs.core.nth.call(null,vec__23174,(0),null);
...
var G__23180 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23181 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23180;
remaining_tokens = G__23181;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23171){
...
var vec__23185 = cljs.core.split_with.call(null,(function (p1__23184_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23184_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23185,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23185,(1),null);
...
var vec__23188 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23188,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23188,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23191 = cljs.core.rest.call(null,remaining_tokens);
var G__23192 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23191;
name_tokens = G__23192;
continue;
} else {
...
var vec__23195 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23195,(0),null);
var arity = cljs.core.nth.call(null,vec__23195,(1),null);
var vec__23198 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23198,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23198,(1),null);
var vec__23201 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23201,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23201,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23201,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23201,(3),null);
...
var vec__23207 = result;
var munged_ns = cljs.core.nth.call(null,vec__23207,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23207,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23207,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23207,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23207,(4),null);
var arity = cljs.core.nth.call(null,vec__23207,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__23211 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__23211,(0),null);
var args = cljs.core.nth.call(null,vec__23211,(1),null);
var vec__23214 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23214,(0),null);
var name = cljs.core.nth.call(null,vec__23214,(1),null);
...
var G__23217 = (arity + (1));
var G__23218 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23219){
var vec__23220 = p__23219;
var arity = cljs.core.nth.call(null,vec__23220,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23220,(1),null);
...
return cljs.core.get.call(null,arities,p1__23223_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23224_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___23231 = arguments.length;
var i__4642__auto___23232 = (0);
while(true){
if((i__4642__auto___23232 < len__4641__auto___23231)){
args__4647__auto__.push((arguments[i__4642__auto___23232]));

var G__23233 = (i__4642__auto___23232 + (1));
i__4642__auto___23232 = G__23233;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23227){
var vec__23228 = p__23227;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23228,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23225){
var G__23226 = cljs.core.first.call(null,seq23225);
var seq23225__$1 = cljs.core.next.call(null,seq23225);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23226,seq23225__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23242__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23242__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23242__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23242__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23243 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23243,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23243,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23243,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23243,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23243,(4),null);
var arity = cljs.core.nth.call(null,vec__23243,(5),null);
...
var o__22249__auto__ = f;
return (o__22249__auto__["getBasis"]).call(o__22249__auto__);
});
/**
...
}catch (e23247){var _e__22256__auto__ = e23247;
...
var G__23248 = (obj[cljs.core.first.call(null,path)]);
var G__23249 = cljs.core.rest.call(null,path);
obj = G__23248;
path = G__23249;
continue;
} else {
...
return (function (accum,p__23250){
var vec__23251 = p__23250;
var bit = cljs.core.nth.call(null,vec__23251,(0),null);
var protocol = cljs.core.nth.call(null,vec__23251,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23254){
var vec__23255 = p__23254;
var ns = cljs.core.nth.call(null,vec__23255,(0),null);
var name = cljs.core.nth.call(null,vec__23255,(1),null);
var selector = cljs.core.nth.call(null,vec__23255,(2),null);
...
return (function (p__23259){
var vec__23260 = p__23259;
var munged_name = cljs.core.nth.call(null,vec__23260,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23260,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23260,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23258_SHARP_){
return (obj[cljs.core.first.call(null,p1__23258_SHARP_)]);
});})(name,sorted_matches,vec__23260,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);

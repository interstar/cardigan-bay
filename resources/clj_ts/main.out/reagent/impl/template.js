...
var G__11617 = o;
(G__11617[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__11619__i < G__11619__a.length) {G__11619__a[G__11619__i] = arguments[G__11619__i + 0]; ++G__11619__i;}
  args = new cljs.core.IndexedSeq(G__11619__a,0,null);
} 
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__11622){
...
var props = map__11623__$1;
var class$ = cljs.core.get.call(null,map__11623__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11625){
var map__11626 = p__11625;
...
var on_write = cljs.core.get.call(null,map__11626__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__11626,map__11626__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__11626,map__11626__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__11631){
...
var synthetic_on_update = cljs.core.get.call(null,map__11632__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__11632__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__11634 = jsprops;
(G__11634["defaultValue"] = value);

(G__11634["onChange"] = ((function (G__11634,v,value,on_change,on_change__$1,map__11632,map__11632__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__11628_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__11628_SHARP_);
});})(G__11634,v,value,on_change,on_change__$1,map__11632,map__11632__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__11644 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11644,(0),null);
var id = cljs.core.nth.call(null,vec__11644,(1),null);
var class$ = cljs.core.nth.call(null,vec__11644,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___11648 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___11648 == null)){
} else {
var key_11649 = temp__5739__auto___11648;
(jsprops["key"] = key_11649);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__11652){
...
var synthetic_input = cljs.core.get.call(null,map__11653__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__11655 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__11655["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__11656 = wrapped;
(G__11656["syntheticInput"] = true);

return G__11656;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__11657 = wrapped__$1;
(G__11657["syntheticOnChange"] = on_change);

return G__11657;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__11659 = wrapped__$2;
(G__11659["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__4047__auto__ = synthetic_input;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11668){
var G__11669 = cljs.core.first.call(null,seq11668);
var seq11668__$1 = cljs.core.next.call(null,seq11668);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11669,seq11668__$1);
});
...
break;
default:
var G__11676 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__11676;
continue;
...
var n__4518__auto___11678 = a.length;
var i_11679 = (0);
while(true){
if((i_11679 < n__4518__auto___11678)){
(a[i_11679] = reagent.impl.template.as_element.call(null,(a[i_11679])));

var G__11680 = (i_11679 + (1));
i_11679 = G__11680;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___11681 = a.length;
var i_11682 = (0);
while(true){
if((i_11682 < n__4518__auto___11681)){
var val_11683 = (a[i_11682]);
if(((cljs.core.vector_QMARK_.call(null,val_11683)) && ((reagent.impl.template.key_from_vec.call(null,val_11683) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_11682] = reagent.impl.template.as_element.call(null,val_11683));
...
var ctx = ({});
var vec__11685 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__11685,(0),null);
var derefed = cljs.core.nth.call(null,vec__11685,(1),null);
...
var G__11688 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11688) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__11688){
